...
<div class="wrapper">
    ...
    <ul>
        ...
        <li>String 3 is de concatenation van string 1 en string 2: <?php $input3 = $input1. $input2; echo $input3; ?>  </li>
        <li>De lengte van string 3 is: 0  characters<?php echo strlen($input3); ?> </li>
        ...
        <li>Zoeken naar "." . Er zit een  "."  op positie <?php echo strpos($input3, "."); ?> </li>
        <li>Zoek naar substring <strong>"PHP"</strong> vervang dit door <strong>"NodeJS"</strong> <?php echo str_replace("PHP", "Node.js", $input3); ?>  </li>
        <li>Wijzig de eerste letter van string 3 naar hoofdletter: <?php ucfirst ("$input1"."$input2"); ?> </li>
        <li>Alles in hoofdletters:  <?php strtoupper("$input1"."$input2");  ?> </li>
        <li>De input kan een valide email zijn: <?php
            if (strpos($input3, '.')  > strpos($input3, '@') + 2 ) {
                echo 'plausibel e-mail adres';
            }
            else {
                echo 'false';
            }?></li>
